...
!function () {
  ...
  var c = {};try {
  ...
  } catch (c) {}var l = (c.navigator || {}).userAgent,
      h = void 0 === l ? "" : l,
      v = c,
    ...
    !function c(l, h) {
      var v = Object.keys(h).reduce(function (c, l) {
        var v = h[l];return v.icon ? c[v.iconName] = v.icon : c[l] = v, c;
      }, {});"function" == typeof M.hooks.addPack ? M.hooks.addPack(l, v) : M.styles[l] = C({}, M.styles[l] || {}, v), "fas" === l && c("fa", h);
    }("fal", s);
  });
}();